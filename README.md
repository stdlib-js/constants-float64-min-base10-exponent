...
```javascript
FLOAT64_MIN_BASE10_EXPONENT = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-base10-exponent@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-base10-exponent@umd/bundle.js"></script>
```
